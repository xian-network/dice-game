...
class TestDice(unittest.TestCase):
    ...
    def test_roll_loss(self):
        ...
        # Lose, so house gets 50.
        self.assertEqual(self.currency.balance_of(
            account='con_uberdice'), 1050)
    ...
    def test_roll_win(self):
        ...
        # Win, so house loses the multiplier of 50.
        self.assertEqual(
            int(self.currency.balance_of(account='con_uberdice')), 819)
    ...
    def test_change_allowed_tokens(self):
        self.uberdice.change_allowed_tokens(
            tokens=['currency', 'other_token'], signer='boi')
        self.assertEqual(self.uberdice.game['allowed_tokens'], [
    ...
    def test_change_max_token_bet(self):
        self.uberdice.change_max_token_bet(
            token_contract='currency', max_bet=100, signer='boi')
